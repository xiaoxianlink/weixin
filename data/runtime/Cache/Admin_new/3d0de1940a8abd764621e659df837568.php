...
<script type="text/javascript">
 ...
 function order(order) {
	 ...
	 window.location.href="<?php echo U('Dingyue/count');?>&order="+order+"&che_number="+che_number+"&che_time_start="+che_time_start+"&che_time_end="+che_time_end; 
 }
</script>
<script type="text/javascript">
...
<body class="J_scroll_fixed">
	<div class="wrap J_check_wrap">
		<div id="cheliang_submit" class="top_div">
			<form action="<?php echo U('Dingyue/count');?> " method="post">
				<input type="submit"   class="query_btn"  value="查询"/>
				<div  id="cheliang_submit" class="query_div" > 
					推送时间 <input type="text" class="input length_3 J_datetime" name="che_time_start" id="che_time_start" value="<?php echo ($time_start); ?>"/> —
		...
		<div class="count_div">
			<div class="count_txt">总推送数：<?php echo ($count); ?></div>
